...
public class BungeeJSONPlugin extends Plugin {
    ...
    public void onLoad() {
        ...
        requestManager.registerEndpoint("/bungeecord/telegram_message", new TelegramMessage());
        requestManager.registerEndpoint("/bungeecord/send_command", new SendCommand());
